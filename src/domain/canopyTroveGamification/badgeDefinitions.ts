...
export const CANOPYTROVE_BADGES: GamificationBadgeDefinition[] = [
  ...
  },
  {
    id: 'scan_lab_curious',
    name: 'Lab Curious',
    description: 'Viewed 5 full COAs',
    icon: 'beaker-outline',
    color: '#7CFFB6',
    category: 'scan',
    points: 25,
  ...
  },
  {
    id: 'scan_brand_scout',
    name: 'Brand Scout',
    description: 'Scanned 10 unique brands',
    icon: 'compass-outline',
    color: '#7CFFB6',
    category: 'scan',
    points: 25,
  ...
  {
    id: 'scan_terpene_explorer',
    name: 'Terpene Explorer',
    description: 'Encountered 5 distinct dominant terpenes',
    icon: 'leaf-outline',
    color: '#40D6FF',
    category: 'scan',
    points: 25,
  ...
  {
    id: 'scan_deep_verifier',
    name: 'Deep Verifier',
    description: '25 product scans total',
  ...
  {
    id: 'scan_clean_choice',
    name: 'Clean Choice',
    description: '10 products scanned that passed all contaminant tests',
    icon: 'shield-checkmark-outline',
    color: '#00F58C',
    category: 'scan',
    points: 25,
  ...
  {
    id: 'scan_cream_of_the_crop',
    name: 'Cream of the Crop',
    description: 'Scanned a product with ≥25% THC',
    icon: 'flame-outline',
    color: '#FFD166',
    category: 'scan',
    points: 50,
