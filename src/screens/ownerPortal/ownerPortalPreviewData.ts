...
export const ownerPortalPreviewStorefront: StorefrontSummary = {
  ...
  promotionText: 'Open late tonight with a faster check-in line.',
  promotionBadges: ['Open Late', 'Tonight', 'Weekend Update'],
...
export const ownerPortalPreviewSearchResults: StorefrontSummary[] = [
  ownerPortalPreviewStorefront,
  {
    ...
    promotionText: 'Owner highlight: community Q&A and late-night hours update.',
    promotionBadges: ['Owner Highlight', 'Community Event'],
...
export const ownerPortalPreviewPromotions: OwnerStorefrontPromotionDocument[] = [
  {
    ...
    storefrontId: ownerPortalPreviewStorefront.id,
    ownerUid: OWNER_PORTAL_PREVIEW_UID,
    title: 'Open late tonight',
    description: 'Featured update highlighting extended hours across Nearby, Browse, and Updates.',
    badges: ['Open Late', 'Tonight', 'Weekend Update'],
  ...
  },
  {
    ...
    storefrontId: ownerPortalPreviewStorefront.id,
    ownerUid: OWNER_PORTAL_PREVIEW_UID,
    title: 'Community Q&A next week',
    description:
      'Separate owner highlight for an in-store community session and updated service details next week.',
    badges: ['Owner Highlight', 'Community Event'],
    startsAt: '2026-04-02T15:00:00.000Z',
    endsAt: '2026-04-06T03:00:00.000Z',
    status: 'scheduled',
    audiences: ['frequent_visitors'],
    alertFollowersOnStart: true,
  ...
  patternFlags: [
    {
      ...
      title: 'Followers react fast to timely updates',
      body: 'Saved followers engage best when the lead update highlights a same-day operational change.',
      tone: 'success',
    },
    {
      id: 'report-open',
