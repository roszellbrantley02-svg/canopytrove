/**
 * Owner promotion placement types and utilities.
 * Local copy for backend — mirrored from frontend src/types/ownerPortal
 * and src/utils/ownerPromotionPlacement.
 */
...
type PriorityPlacementSummary = {
  id: string;
  marketId: string;
  activePromotionId?: string | null;
  premiumCardVariant?: string | null;
  promotionPlacementSurfaces?: string[] | null;
